...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Selected product: " + productChosen + " Price: " + productPrice + "$");
